...
<div className='m-3'>
    <Button variant="secondary" className='btn btn-danger' onClick={() => window.location.reload(false)}>Activated; Click to refresh it</Button>
        ...
        Launch static backdrop modal
            ...
            >
                <Modal.Header closeVariant="white" closeButton className="modelMianHeadr" >
                    <Modal.Title className="modelMian modelHeader">Install Wallet</Modal.Title>
                </Modal.Header>
                <Modal.Body className='d-flex flex-column p-3 mt-1 modelMian' style={{ alignItems: "center", color: "#FFFFFF" }}>
                    ...
                    <div className='m-3'>
                        ...
                        <a target="_blank" href='https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn?hl=en' ><Button variant="secondary" className='btn btn-info'>Click here to activate the wallet</Button></a>
                    </div>
                    <div className='m-3'>
                        <Button variant="secondary" className='btn btn-danger' onClick={() => window.location.reload(false)}>Activated; Click to refresh it</Button>
                    </div>
